...
const arr8: string[] = day8Input.split(/\n/)

const arrMapped: Array<Array<string | number>> = arr8.map((str) => {
  const arr: string[] = str.split(" ")
  return [arr[0], +arr[1]]
})

const arrLength: number = arr8.length
